...
if(player_chara != noone) {
	var player_above_bbox =			player_chara.y + player_chara.sprite_height - player_chara.sprite_yoffset < bbox_top + 1
	var player_behind_building =	player_chara.y + player_chara.sprite_height - player_chara.sprite_yoffset > y - sprite_yoffset
	var player_in_building_width =	player_chara.bbox_left + 1 < bbox_right && player_chara.bbox_right - 1 > bbox_left
								
	if(player_above_bbox && player_behind_building && player_in_building_width) {
		see_through_building(player_chara)
	}
	else {
		draw_self()
		fade_in = false
